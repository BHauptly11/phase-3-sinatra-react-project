...
a3 = Album.create(name: "Toxicity", genre: "Rock", artist: "System of a Down", release_year: 2001, image_url: "./images/Toxicity.png", person: p1, like: 0)
a4 = Album.create(name: "Lateralus", genre: "Rock", artist: "TOOL", release_year: 2001, image_url: "./images/Lateralus.png", person: p1, like: 0)
...
a6 = Album.create(name: "The Predator", genre: "Rap", artist: "Ice Cube", release_year: 1992, image_url: "./images/The_Predator.png", person: p1, like: 0)
a7 = Album.create(name: "Straight Outta Compton", genre: "Rap", artist: "N.W.A", release_year: 1988, image_url: "./images/Straight_Outta_Compton.png", person: p1, like: 0)
a8 = Album.create(name: "Ta13oo", genre: "Rap", artist: "Denzel Curry", release_year: 2018, image_url: "./images/Ta13boo.png", person: p1, like: 0)
a9 = Album.create(name: "Stankonia", genre: "Rap", artist: "OutKast", release_year: 2000, image_url: "./images/Stankonia.png", person: p1, like: 0)
a10 = Album.create(name: "All Eyez On Me", genre: "Rap", artist: "2Pac", release_year: 1996, image_url: "./images/All_Eyes_On_Me.png", person: p1, like: 0)
